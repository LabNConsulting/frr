...
extern void update_group_show_advertised(struct bgp *bgp, afi_t afi, safi_t safi,
					 struct vty *vty, uint64_t id);
...
extern int update_group_clear_update_dbg(struct update_group *updgrp, void *arg);
