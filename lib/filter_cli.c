...
static int acl_remove_if_empty(struct vty *vty, const char *iptype, const char *name)
{
 ...
 */
DEFPY_YANG(access_list_std, access_list_std_cmd,
	   "access-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <[host] A.B.C.D$host|A.B.C.D$host A.B.C.D$mask>",
	   ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
...
DEFPY_YANG(no_access_list_std, no_access_list_std_cmd,
	   "no access-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <[host] A.B.C.D$host|A.B.C.D$host A.B.C.D$mask>",
	   NO_STR ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
	   "A single host address\n"
	   "Address to match\n"
	   "Address to match\n"
	   "Wildcard bits\n")
...
DEFPY_YANG(access_list_ext, access_list_ext_cmd,
...
DEFPY_YANG(no_access_list_ext, no_access_list_ext_cmd,
 ...
 * Zebra access lists.
 */
DEFPY_YANG(access_list, access_list_cmd,
...
DEFPY_YANG(no_access_list, no_access_list_cmd,
...
DEFPY_YANG(no_access_list_all, no_access_list_all_cmd, "no access-list WORD$name",
...
DEFPY_YANG(ipv6_access_list, ipv6_access_list_cmd,
	   "ipv6 access-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <X:X::X:X/M$prefix [exact-match$exact]|any>",
	   IPV6_STR ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
	   "IPv6 prefix\n"
	   "Exact match of the prefixes\n"
	   "Match any IPv6\n")
{
...
DEFPY_YANG(no_ipv6_access_list, no_ipv6_access_list_cmd,
...
DEFPY_YANG(no_ipv6_access_list_remark, no_ipv6_access_list_remark_cmd,
	   ...
	   NO_STR IPV6_STR ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_REMARK_STR)
{
	char xpath[XPATH_MAXLEN];
	int rv;
...
DEFPY_YANG(mac_access_list, mac_access_list_cmd,
	   "mac access-list ACCESSLIST_MAC_NAME$name [seq (1-4294967295)$seq] <deny|permit>$action <X:X:X:X:X:X$mac|any>",
	   MAC_STR ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
	   "MAC address\n"
...
DEFPY_YANG(no_mac_access_list, no_mac_access_list_cmd,
...
DEFPY_YANG(no_mac_access_list_remark, no_mac_access_list_remark_cmd,
	   ...
	   NO_STR MAC_STR ACCESS_LIST_STR ACCESS_LIST_ZEBRA_STR ACCESS_LIST_REMARK_STR)
{
	char xpath[XPATH_MAXLEN];
	int rv;
...
DEFPY_YANG(ip_prefix_list, ip_prefix_list_cmd,
	   "ip prefix-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <any|A.B.C.D/M$prefix [{ge (0-32)$ge|le (0-32)$le}]>",
	   IP_STR PREFIX_LIST_STR PREFIX_LIST_NAME_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
...
DEFPY_YANG(no_ip_prefix_list, no_ip_prefix_list_cmd,
	   "no ip prefix-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <any|A.B.C.D/M$prefix [{ge (0-32)|le (0-32)}]>",
	   NO_STR IP_STR PREFIX_LIST_STR PREFIX_LIST_NAME_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
	   "Any prefix match.  Same as \"0.0.0.0/0 le 32\"\n"
	   "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
	   "Minimum prefix length to be matched\n"
	   "Minimum prefix length\n"
...
DEFPY_YANG(ipv6_prefix_list, ipv6_prefix_list_cmd,
	   "ipv6 prefix-list WORD$name [seq (1-4294967295)] <deny|permit>$action <any|X:X::X:X/M$prefix [{ge (0-128)$ge|le (0-128)$le}]>",
	   IPV6_STR PREFIX_LIST_STR PREFIX_LIST_NAME_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
...
DEFPY_YANG(no_ipv6_prefix_list, no_ipv6_prefix_list_cmd,
	   "no ipv6 prefix-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action <any|X:X::X:X/M$prefix [{ge (0-128)$ge|le (0-128)$le}]>",
	   NO_STR IPV6_STR PREFIX_LIST_STR PREFIX_LIST_NAME_STR ACCESS_LIST_SEQ_STR ACCESS_LIST_ACTION_STR
	   "Any prefix match.  Same as \"::0/0 le 128\"\n"
	   "IPv6 prefix <network>/<length>, e.g., 3ffe::/16\n"
	   "Maximum prefix length to be matched\n"
	   "Maximum prefix length\n"
...
DEFPY_YANG(no_ipv6_prefix_list_remark, no_ipv6_prefix_list_remark_cmd,
	   ...
	   NO_STR IPV6_STR PREFIX_LIST_STR PREFIX_LIST_NAME_STR ACCESS_LIST_REMARK_STR)
{
	char xpath[XPATH_MAXLEN];
	int rv;
