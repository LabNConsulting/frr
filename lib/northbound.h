 ...
 */
extern void *nb_op_walk(const char *xpath, struct yang_translator *translator,
 ...
 */
extern void nb_op_cancel_walk(void *walk);

/**
 * nb_op_cancel_all_walks() - cancel all in progress walks.
 */
extern void nb_op_cancel_all_walks(void);
