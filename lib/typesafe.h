...
#define frr_each_safe(prefix, head, item)                                      \
	for (typeof(prefix##_next_safe(head, NULL)) prefix##_safe =            \
	     ...
	     item = prefix##_safe, prefix##_safe =                             \
					   prefix##_next_safe(head, prefix##_safe))
...
#define frr_rev_each_safe(prefix, head, item)                                  \
	for (typeof(prefix##_prev_safe(head, NULL)) prefix##_safe =            \
	     ...
	     item;                                                             \
	     item = prefix##_safe, prefix##_safe =                             \
					   prefix##_prev_safe(head, prefix##_safe))
...
#define _DECLARE_SORTLIST(prefix, type, field, cmpfn_nuq, cmpfn_uq)                      \
	...
	macro_inline const type *prefix##_const_find_gteq(const struct prefix##_head *h, \
							  const type *item)              \
	{                                                                                \
	...
	macro_inline const type *prefix##_const_find_lt(const struct prefix##_head *h,   \
							const type *item)                \
	{                                                                                \
