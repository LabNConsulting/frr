...
static const struct option lo_cfg[] = {{"config_file", required_argument, NULL,
					'f'},
...
static const struct option lo_fullcli[] = {{"terminal", no_argument, NULL, 't'},
					   {"tcli", no_argument, NULL,
					    OPTION_TCLI},
#ifdef HAVE_SQLITE3
					   {"db_file", required_argument, NULL,
					    OPTION_DB_FILE},
#endif
					   {NULL}};
...
static const struct option lo_vty[] = {{"vty_addr", required_argument, NULL,
					'A'},
				       {"vty_port", required_argument, NULL,
					'P'},
				       {NULL}};
