...
extern void qcountfree(struct memtype *mt, void *ptr) __attribute__((nonnull(1)));
...
extern __attribute__((__noreturn__)) void memory_oom(size_t size, const char *name);
