...
DEFUN_HIDDEN(config_log_monitor, config_log_monitor_cmd,
...
DEFUN_HIDDEN(no_config_log_monitor, no_config_log_monitor_cmd,
...
DEFUN(no_config_log_file, no_config_log_file_cmd, "no log file [FILENAME [LEVEL]]",
      NO_STR "Logging control\n"
