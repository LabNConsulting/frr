		  ...
		  "command to pass to new parser\n")
{
	...
	struct cmd_element *cmd = XCALLOC(MTYPE_CMD_DESCRIPTIONS,
		  ...
		  "command to complete\n")
{
	...
	enum matcher_rv result = command_complete(nodegraph, command,
						  &completions);
		  ...
		  "command to match\n")
{
	...
	enum matcher_rv result = command_match(nodegraph, command, &argvv,
					       &element);
