...
extern int nexthop_g_addr_cmp(enum nexthop_types_t type, const union g_addr *addr1,
...
extern struct nexthop *nexthop_next_active_resolved(const struct nexthop *nexthop);
