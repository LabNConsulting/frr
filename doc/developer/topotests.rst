...
.. code:: shell
   ...
   # Install custom socat tool to run PIMv6 tests. Currently socat
   # version 1.7.4.2 does not have required PIMv6 changes for
   # join and traffic, so the code MUST be taken from the below url.
