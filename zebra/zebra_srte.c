...
static inline int zebra_sr_policy_instance_compare(const struct zebra_sr_policy *a,
...
struct zebra_sr_policy *zebra_sr_policy_find(uint32_t color, struct ipaddr *endpoint)
{
	struct zebra_sr_policy policy = {};
