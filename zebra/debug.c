...
DEFUN_NOSH(show_debugging_zebra, show_debugging_zebra_cmd, "show debugging [zebra]",
...
DEFPY(debug_zebra_mpls, debug_zebra_mpls_cmd, "debug zebra mpls [detailed$detail]",
      DEBUG_STR "Zebra configuration\n"
...
DEFUN(debug_zebra_dplane, debug_zebra_dplane_cmd, "debug zebra dplane [detailed]",
      DEBUG_STR "Zebra configuration\n"
...
DEFUN(no_debug_zebra_nht, no_debug_zebra_nht_cmd, "no debug zebra nht [detailed]",
      NO_STR DEBUG_STR "Zebra configuration\n"
		       "Debug option set for zebra next hop tracking\n"
		       "Debug option set for detailed info\n")
{
...
DEFUN(no_debug_zebra_rib, no_debug_zebra_rib_cmd, "no debug zebra rib [detailed]",
      NO_STR DEBUG_STR "Zebra configuration\n"
		       "Debug zebra RIB\n"
		       "Detailed debugs\n")
{
