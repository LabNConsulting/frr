...
extern void kernel_pbr_ipset_entry_add_del_status(struct zebra_pbr_ipset_entry *ipset,
						  enum zebra_dplane_status res);
...
extern void zebra_pbr_show_rule_unit(struct zebra_pbr_rule *rule, struct vty *vty);
