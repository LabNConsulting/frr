...
static inline bool zebra_evpn_es_local_mac_via_network_port(struct zebra_evpn_es *es)
{
...
extern struct zebra_evpn_es_evi *zebra_evpn_es_evi_find(struct zebra_evpn_es *es,
							struct zebra_evpn *zevpn);
