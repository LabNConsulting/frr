...
extern int netlink_nexthop_change(struct nlmsghdr *h, ns_id_t ns_id, int startup);
...
extern enum netlink_msg_status
netlink_put_nexthop_update_msg(struct nl_batch *bth, struct zebra_dplane_ctx *ctx);
extern enum netlink_msg_status
