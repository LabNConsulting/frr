 ...
 */
void zebra_l2_vxlanif_update_access_vlan(struct interface *ifp, vlanid_t access_vlan)
{
	struct zebra_if *zif;
 ...
 */
void zebra_l2if_update_bridge_slave(struct interface *ifp, ifindex_t bridge_ifindex,
