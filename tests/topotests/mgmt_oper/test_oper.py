...
# vtysh -c 'show mgmt get-data /frr-vrf:lib'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib-vrf-nokey.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib-vrf-default.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="red"]'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib-vrf-red.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]/frr-zebra:zebra'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib-vrf-zebra.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]/frr-zebra:zebra/ribs'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-lib-vrf-zebra-ribs.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]/frr-zebra:zebra/ribs/rib[afi-safi-name="frr-routing:ipv4-unicast"][table-id="254"]'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-ribs-rib-ipv4-unicast.json # noqa: 501
# vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]/frr-zebra:zebra/ribs/rib'  > ~chopps/w/frr/tests/topotests/mgmt_oper/oper-results/result-ribs-rib-nokeys.json # noqa: 501
# # noqa: 501
