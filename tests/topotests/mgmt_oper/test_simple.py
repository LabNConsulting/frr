...
# Interfaces
vtysh -c 'show mgmt get-data /frr-interface:lib' > ${resdir}/result-intf.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface' > ${resdir}/result-intf-intf.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface/name' > ${resdir}/result-intf-name.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface/state' > ${resdir}/result-intf-state.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface/state/mtu' > ${resdir}/result-intf-state-mtu.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"]/name' > ${resdir}/result-intf-eth0-name.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"]/vrf' > ${resdir}/result-intf-eth0-vrf.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"]/state' > ${resdir}/result-intf-eth0-state.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"]/state/mtu' > ${resdir}/result-intf-eth0-state-mtu.json
# VRF
...
# Leaf reference
vtysh -c 'show mgmt get-data /frr-vrf:lib/vrf[name="default"]/frr-zebra:zebra/ribs/rib[afi-safi-name="frr-routing:ipv4-unicast"][table-id="254"]/route[prefix="1.1.1.0/24"]/route-entry[protocol="connected"]/metric' > ${resdir}/result-singleton-metric.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"] with-config' > ${resdir}/result-intf-eth0-with-config.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface[name="r1-eth0"] only-config' > ${resdir}/result-intf-eth0-only-config.json
vtysh -c 'show mgmt get-data /frr-interface:lib/interface/description with-config' > ${resdir}/result-intf-description.json
